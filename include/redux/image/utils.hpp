...
namespace redux {
    ...
    namespace image {
        ...
        template <typename T, typename U>
        void mozaic( boost::asio::io_context& service, size_t nThreads, T** img, size_t imgRows, size_t imgCols, const U*** patches, size_t nPatches,
        ...
        void mozaic( T** img, size_t imgRows, size_t imgCols, const U*** patches, size_t nPatches, size_t pRows, size_t pCols,
            ...
            {
                //boost::asio::executor_work_guard<boost::asio::io_context::executor_type> workLoop(service);
                auto workLoop = boost::asio::make_work_guard(service);
